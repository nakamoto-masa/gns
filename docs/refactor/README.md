...
**Note**: All documents are available in both Japanese (`.ja.md`) and English (`.md`) versions.
...
- [decisions/](decisions/) - Design decision records (all bilingual)
...
4. Refer to individual documents as needed
